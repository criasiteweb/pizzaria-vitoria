...
const CARDAPIO = [
  ...
  { id:"s2",  g:"salgadas", n:"02 · Aliche", d:"Mussarela e aliche.", pz:true, t:{grande:52.00}, add:"pizza", f:"atum" },
  { id:"s3",  g:"salgadas", n:"03 · A Moda da Casa", d:"Escarola, presunto, palmito, ervilha, bacon, parmesão e mussarela.", pz:true, t:{grande:57.00}, add:"pizza", f:"especial" },
  { id:"s4",  g:"salgadas", n:"04 · A Moda do Chefe", d:"Calabresa, presunto, ervilha, bacon, mussarela e palmito.", pz:true, t:{grande:57.00}, add:"pizza", f:"especial" },
  { id:"s5",  g:"salgadas", n:"05 · A Moda do Freguês", d:"A pizza mais completa da casa. Peça pelo WhatsApp que a gente conta o que vai nela.", pz:true, t:{grande:62.00}, add:"pizza", f:"especial" },
  { id:"s6",  g:"salgadas", n:"06 · A Moda do Jack", d:"Escarola, bacon, parmesão, gorgonzola, alho e manjericão.", pz:true, t:{grande:54.00}, add:"pizza", f:"gorgonzola" },
  { id:"s7",  g:"salgadas", n:"07 · Atum I", d:"Atum, salsa e cebola.", pz:true, t:{grande:54.00}, add:"pizza", f:"atum" },
  { id:"s8",  g:"salgadas", n:"08 · Atum II", d:"Atum, cebola e mussarela.", pz:true, t:{grande:56.00}, add:"pizza", f:"atum" },
  { id:"s9",  g:"salgadas", n:"09 · Bacon", d:"Mussarela, bacon e cebola.", pz:true, t:{grande:54.00}, add:"pizza", f:"bacon" },
  ...
  { id:"s13", g:"salgadas", n:"13 · Batata II", d:"Batata, bacon, parmesão e requeijão.", pz:true, t:{grande:60.00}, add:"pizza", f:"batata" },
  { id:"s14", g:"salgadas", n:"14 · Brócolis", d:"Brócolis refogado, bacon e mussarela.", pz:true, t:{grande:50.00}, add:"pizza", tag:"Promoção", f:"brocolis" },
  { id:"s15", g:"salgadas", n:"15 · Brócolis Cremoso", d:"Brócolis, bacon e requeijão.", pz:true, t:{grande:56.00}, add:"pizza", f:"brocolis" },
  ...
  { id:"s20", g:"salgadas", n:"20 · Carne Seca I", d:"Carne seca, milho e catupiry.", pz:true, t:{grande:60.00}, add:"pizza", f:"carne" },
  { id:"s21", g:"salgadas", n:"21 · Carne Seca II", d:"Carne seca, milho e mussarela.", pz:true, t:{grande:60.00}, add:"pizza", f:"carne" },
  { id:"s22", g:"salgadas", n:"22 · Costela", d:"Costela, barbecue, bacon e mussarela.", pz:true, t:{grande:60.00}, add:"pizza", f:"carne" },
  { id:"s23", g:"salgadas", n:"23 · Dogão", d:"Mussarela, salsicha, milho, ervilha, batata palha, cheddar e catupiry.", pz:true, t:{grande:58.00}, add:"pizza", f:"especial" },
  ...
  { id:"s26", g:"salgadas", n:"26 · Frango Crocante", d:"Frango desfiado, cheddar e batata palha.", pz:true, t:{grande:55.00}, add:"pizza", f:"frango" },
  ...
  { id:"s31", g:"salgadas", n:"31 · Francesa", d:"Presunto, champignon e mussarela.", pz:true, t:{grande:52.00}, add:"pizza", f:"champignon" },
  { id:"s32", g:"salgadas", n:"32 · Florença", d:"Carne moída à bolonhesa e catupiry.", pz:true, t:{grande:52.00}, add:"pizza", f:"carne" },
  { id:"s33", g:"salgadas", n:"33 · Gorgonzola", d:"Mussarela e gorgonzola.", pz:true, t:{grande:54.00}, add:"pizza", f:"gorgonzola" },
  { id:"s34", g:"salgadas", n:"34 · Italiana", d:"Calabresa, cebola, mussarela e bacon.", pz:true, t:{grande:54.00}, add:"pizza", f:"calabresa" },
  { id:"s35", g:"salgadas", n:"35 · Japonesa", d:"Atum, aliche, cebola e mussarela.", pz:true, t:{grande:57.00}, add:"pizza", f:"atum" },
  { id:"s36", g:"salgadas", n:"36 · Jardim", d:"Palmito, cebola e mussarela.", pz:true, t:{grande:56.00}, add:"pizza", f:"palmito" },
  ...
  { id:"s38", g:"salgadas", n:"38 · Lombo I", d:"Lombo, cebola e catupiry.", pz:true, t:{grande:56.00}, add:"pizza", f:"lombo" },
  { id:"s39", g:"salgadas", n:"39 · Lombo II", d:"Lombo, cebola e mussarela.", pz:true, t:{grande:56.00}, add:"pizza", f:"lombo" },
  { id:"s40", g:"salgadas", n:"40 · Mista", d:"Presunto, calabresa, cebola e mussarela.", pz:true, t:{grande:56.00}, add:"pizza", f:"presunto" },
  { id:"s41", g:"salgadas", n:"41 · Margherita", d:"Mussarela, tomate, molho e manjericão.", pz:true, t:{grande:51.00}, add:"pizza", f:"marguerita" },
  { id:"s42", g:"salgadas", n:"42 · Milho I", d:"Milho e catupiry.", pz:true, t:{grande:55.00}, add:"pizza", f:"milho" },
  { id:"s43", g:"salgadas", n:"43 · Milho II", d:"Milho e mussarela.", pz:true, t:{grande:55.00}, add:"pizza", f:"milho" },
  ...
  { id:"s45", g:"salgadas", n:"45 · Mussarela Crocante", d:"Batata palha, bacon e mussarela.", pz:true, t:{grande:56.00}, add:"pizza", f:"batata" },
  { id:"s46", g:"salgadas", n:"46 · Namorados", d:"Mussarela, palmito, champignon e catupiry.", pz:true, t:{grande:56.00}, add:"pizza", f:"palmito" },
  { id:"s47", g:"salgadas", n:"47 · Napolitana", d:"Mussarela, tomate, molho e parmesão.", pz:true, t:{grande:52.00}, add:"pizza", f:"marguerita" },
  { id:"s48", g:"salgadas", n:"48 · Pepperoni", d:"Mussarela e pepperoni.", pz:true, t:{grande:60.00}, add:"pizza", f:"peperoni" },
  { id:"s49", g:"salgadas", n:"49 · Peruana", d:"Atum, cebola, ervilha e mussarela.", pz:true, t:{grande:57.00}, add:"pizza", f:"atum" },
  { id:"s50", g:"salgadas", n:"50 · Pipinela", d:"Mussarela, lombo, champignon e bacon.", pz:true, t:{grande:57.00}, add:"pizza", f:"lombo" },
  { id:"s51", g:"salgadas", n:"51 · Presuntão", d:"Presunto picado com mussarela.", pz:true, t:{grande:50.00}, add:"pizza", tag:"Promoção", f:"presunto" },
  { id:"s52", g:"salgadas", n:"52 · Princesa I", d:"Escarola, bacon e catupiry.", pz:true, t:{grande:50.00}, add:"pizza", tag:"Promoção", f:"escarola" },
  { id:"s53", g:"salgadas", n:"53 · Princesa II", d:"Escarola, bacon, aliche e mussarela.", pz:true, t:{grande:51.00}, add:"pizza", f:"escarola" },
  { id:"s54", g:"salgadas", n:"54 · Ponto Chic", d:"Presunto, tomate e mussarela.", pz:true, t:{grande:52.00}, add:"pizza", f:"presunto" },
  { id:"s55", g:"salgadas", n:"55 · Portuguesa", d:"Presunto, ervilha, ovo, milho, cebola e mussarela.", pz:true, t:{grande:52.00}, add:"pizza", f:"portuguesa" },
  { id:"s56", g:"salgadas", n:"56 · 2 Queijos", d:"Mussarela e catupiry.", pz:true, t:{grande:52.00}, add:"pizza", f:"queijos" },
  ...
  { id:"s60", g:"salgadas", n:"60 · Rúcula", d:"Rúcula, mussarela e tomate seco.", pz:true, t:{grande:54.00}, add:"pizza", f:"rucula" },
  { id:"s61", g:"salgadas", n:"61 · Toscana", d:"Calabresa, tomate e mussarela.", pz:true, t:{grande:52.00}, add:"pizza", f:"calabresa" },
  { id:"s62", g:"salgadas", n:"62 · Troiana", d:"Mussarela, lombo, bacon, parmesão e catupiry.", pz:true, t:{grande:56.00}, add:"pizza", f:"lombo" },
  { id:"s63", g:"salgadas", n:"63 · Vegetariana", d:"Escarola, milho, ervilha, champignon e mussarela.", pz:true, t:{grande:53.00}, add:"pizza", f:"vegetariana" },
  { id:"s64", g:"salgadas", n:"64 · Veneza", d:"Presunto picado, milho, palmito, bacon e mussarela.", pz:true, t:{grande:53.00}, add:"pizza", f:"palmito" },
  { id:"s65", g:"salgadas", n:"65 · Vitória", d:"Mussarela, lombo, champignon, bacon, milho e catupiry.", pz:true, t:{grande:57.00}, add:"pizza", tag:"Da casa", f:"especial" },
  { id:"s66", g:"salgadas", n:"66 · Volkolver", d:"Presunto, milho, bacon, cheddar, frango, batata palha e mussarela.", pz:true, t:{grande:60.00}, add:"pizza", f:"especial" },

  /* ================= PIZZAS DOCES ================= */
  { id:"d1",  g:"doces", n:"01 · Abacaxi 1", d:"Abacaxi, leite condensado e canela.", pz:true, t:{grande:53.00}, f:"doce-abacaxi" },
  { id:"d2",  g:"doces", n:"02 · Abacaxi 2", d:"Abacaxi e doce de leite.", pz:true, t:{grande:53.00}, f:"doce-abacaxi" },
  { id:"d3",  g:"doces", n:"03 · Banana", d:"Catupiry, banana, canela e leite condensado.", pz:true, t:{grande:47.00}, f:"doce-banana" },
  { id:"d4",  g:"doces", n:"04 · Banoff", d:"Banana, doce de leite e marshmallow.", pz:true, t:{grande:49.00}, f:"doce-banana" },
  ...
  { id:"d17", g:"doces", n:"17 · Mineira", d:"Doce de leite e mussarela.", pz:true, t:{grande:48.00}, f:"doce-leite" },
  { id:"d18", g:"doces", n:"18 · Morango", d:"Morango e chocolate.", pz:true, t:{grande:54.00}, tag:"Campeã", f:"doce-morango" },
  ...
  { id:"d22", g:"doces", n:"22 · Paçoca I", d:"Doce de leite e paçoca.", pz:true, t:{grande:49.00}, f:"doce-leite" },
  ...
  { id:"d25", g:"doces", n:"25 · Romeu e Julieta", d:"Goiabada e mussarela.", pz:true, t:{grande:47.00}, f:"doce-leite" },
  { id:"d26", g:"doces", n:"26 · Sedução", d:"Banana e chocolate.", pz:true, t:{grande:47.00}, f:"doce-banana" },
  ...
  { id:"d29", g:"doces", n:"29 · Uva", d:"Chocolate e uva.", pz:true, t:{grande:55.00}, f:"doce-morango" },

  /* ================= LANCHES ================= */
  { id:"l1",  g:"lanches", n:"Hambúrguer", d:"Hambúrguer, cebola, maionese, ketchup e mostarda.", p:16.50, add:"lanche", f:"hamburguer" },
  { id:"l2",  g:"lanches", n:"X-Burguer", d:"Hambúrguer, queijo, cebola, maionese, ketchup e mostarda.", p:17.50, add:"lanche", f:"hamburguer" },
  { id:"l3",  g:"lanches", n:"X-Salada", d:"Hambúrguer, queijo, alface, tomate, cebola, maionese, ketchup e mostarda.", p:19.50, add:"lanche", f:"hamburguer" },
  { id:"l4",  g:"lanches", n:"X-Egg", d:"Hambúrguer, ovo, queijo, cebola, maionese, ketchup e mostarda.", p:19.50, add:"lanche", f:"hamburguer" },
  { id:"l5",  g:"lanches", n:"X-Bacon", d:"Hambúrguer, queijo, bacon, cebola, maionese, ketchup e mostarda.", p:19.50, add:"lanche", f:"hamburguer" },
  { id:"l6",  g:"lanches", n:"X-Egg Bacon", d:"Hambúrguer, ovo, bacon, cebola, maionese, ketchup e mostarda.", p:20.50, add:"lanche", f:"hamburguer" },
  { id:"l7",  g:"lanches", n:"X-Egg Salada", d:"Hambúrguer, ovo, queijo, alface, tomate, cebola, maionese, ketchup e mostarda.", p:20.50, add:"lanche", f:"hamburguer" },
  { id:"l8",  g:"lanches", n:"X-Bacon Salada", d:"Hambúrguer, bacon, queijo, alface, tomate, cebola, maionese, ketchup e mostarda.", p:20.50, add:"lanche", f:"hamburguer" },
  { id:"l9",  g:"lanches", n:"X-Bacon Egg Salada", d:"Hambúrguer, ovo, bacon, queijo, alface, tomate, cebola, maionese, ketchup e mostarda.", p:22.00, add:"lanche", f:"hamburguer" },
  { id:"l10", g:"lanches", n:"X-Tudo", d:"Hambúrguer, bacon, ovo, presunto, queijo, alface, tomate, cebola, maionese, ketchup e mostarda.", p:23.50, add:"lanche", tag:"O maior", f:"hamburguer" },
